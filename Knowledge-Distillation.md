...
- **Student model**: small, fast, lightweight
- Student learns:
  - Ground truth labels
...
2. Generate soft outputs (probabilities)
3. Train Student using:
...
- **Response-based**: learns final outputs
- **Feature-based**: learns intermediate representations
- **Relation-based**: learns relationships between samples
...
- CNN models (ResNet, VGG compression)
...
- Depends on strong Teacher model
...
### Quantization
- Reduces numeric precision (e.g., FP32 → INT8)

### Pruning
- Removes unimportant weights

### Distillation
- Transfers knowledge instead of removing parameters
...
- LLM distillation at scale
- Multi-teacher distillation
- Cross-modal distillation (image ↔ text)
